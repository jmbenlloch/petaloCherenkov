...
def processData(params):
    ...
    asic = params[4]
    sptr = params[5]
    print "vel: {}, pde: {}, asic: {}, sptr: {}, minwl: {}, maxwl: {}".format(vel,pde,asic,sptr,minwl,maxwl)
    ...
    data['dtof'] = result['dtof'].tolist()
    data['wl1'] = result['wl1'].tolist()
    data['wl2'] = result['wl2'].tolist()
...
if __name__ == "__main__":
    ...
    configs = [(210,pde,minwl,1500, asic, sptr) for pde in pdes for minwl in minwls for asic in asics for sptr in sptrs]
