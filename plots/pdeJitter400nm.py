...
#    result = petalo.computeDTOF(vel)
        result = collection.find_one({'vel': 210, 'pde': pde, 'minwl': 400, 'maxwl': 1500, 'asic': 0, 'sptr': sptr})
        ...
        h1.Draw()
        c1.Print('plots/400nm-jitter/minwl_400nm_sptr_' + str(sptr) + '_pde_' + str(pde) + '.png')
...
leg.Draw('same')
c2.Print('plots/400nm-jitter/400nm-jitter.png')
